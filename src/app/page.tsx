  ...
  return (
    <main className="flex h-dvh min-h-[720px] overflow-hidden bg-white">
      <div className="flex min-h-0 w-full flex-col">
        ...
        <section className="shrink-0 bg-brand py-7 text-white">
          <div className={`${DESKTOP_CONTAINER} grid h-[318px] grid-cols-[1fr_470px] items-center gap-12`}>
            <div>
              <p className="text-xs font-bold tracking-wide text-gold-warm">GRIDDLE &amp; GRILL</p>
              <h1 className="mt-3 max-w-xl text-5xl font-bold leading-[0.96] tracking-tight">
                Order Fresh.
                <br />
                Eat Bold.
              </h1>
