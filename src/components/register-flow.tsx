...
const editButtonClass = "cursor-pointer rounded-md px-2 py-1 text-brand transition hover:bg-brand-tint hover:text-brand-deep focus:outline-none focus:ring-2 focus:ring-brand/20";
...
export function RegisterFlow() {
  ...
  const renderShell = (children: ReactNode) => (
    <main className="auth-shell-bg grid min-h-dvh place-items-center px-4 py-10">
      ...
      <div className={`relative w-full overflow-hidden rounded-2xl border border-border border-t-4 border-t-brand bg-white shadow-[0_24px_70px_rgba(17,17,17,0.18)] ring-1 ring-black/[0.04] ${cardWidth}`}>
